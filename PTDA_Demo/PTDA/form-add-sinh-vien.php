...
<head>
  <title>Thêm Sinh Viên | Quản trị Admin</title>
  <meta charset="utf-8">
  ...
  <main>
    ...
    <form method="POST">
      <div>
        ...
        <input type="text" name="studentIdn" id="studentId" placeholder="Nhập mã sinh viên">
      </div>
      <div>
      ...
      <div>
        <input type="submit" name='them' value="LUU LAI">
    ...
    <?php
          if(isset($_POST['them'])){
            ...
            $sql="INSERT INTO user(iD,fullName,address,gender,sDt,username,password) VALUES ('$masv','$tensv','$diachi','$gioitinh','$phone','$username','$password')";
            $mysqli->query($sql);
            $mysqli->close();
